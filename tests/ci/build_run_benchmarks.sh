...
taskset -c 4 ./"${PR_FOLDER_NAME}"/build/tool/awslc_bm -timeout 5 -json > aws-lc-pr_bm.json &
pr_pid=$!
taskset -c 5 ./"${PR_FOLDER_NAME}"/fips_build/tool/awslc_bm -timeout 5 -json > aws-lc-pr_fips_bm.json &
pr_fips_pid=$!

taskset -c 6 ./aws-lc-prod/build/tool/awslc_bm -timeout 5 -json > aws-lc-prod_bm.json &
prod_pid=$!
taskset -c 7 ./aws-lc-prod/fips_build/tool/awslc_bm -timeout 5 -json > aws-lc-prod_fips_bm.json &
prod_fips_pid=$!

taskset -c 8 ./"${PR_FOLDER_NAME}"/build/tool/ossl_bm -timeout 5 -json > ossl_bm.json &
ossl_pid=$!
taskset -c 9 ./"${PR_FOLDER_NAME}"/build/tool/bssl_bm -timeout 5 -json > bssl_bm.json &
bssl_pid=$!
...
taskset -c 4 ./"${PR_FOLDER_NAME}"/build/tool/awslc_bm -filter trusttoken -timeout 5 -json > aws-lc-pr_tt_bm.json
taskset -c 5 ./"${PR_FOLDER_NAME}"/fips_build/tool/awslc_bm -filter trusttoken -timeout 5 -json > aws-lc-pr_tt_fips_bm.json
taskset -c 6 ./aws-lc-prod/build/tool/awslc_bm -filter trusttoken -timeout 5 -json > aws-lc-prod_tt_bm.json
taskset -c 7 ./aws-lc-prod/fips_build/tool/awslc_bm -filter trusttoken -timeout 5 -json > aws-lc-prod_tt_fips_bm.json
taskset -c 9 ./"${PR_FOLDER_NAME}"/build/tool/bssl_bm -filter trusttoken -timeout 5 -json > bssl_tt_bm.json
